  ...
  return (
    <div className="relative">
      ...
      <section className="absolute bottom-5 right-5 z-40 flex flex-col justify-end items-end gap-2">
        {isBotRelease && (
          <div className="rounded-md w-[20rem]  md:w-[25rem] lg:w-[25rem] h-[70vh] bg-white">
            ...
            <div
                ...
                >
                  <div className="justify-end self-end px-5 py-2 rounded-md bg-blue-200 w-auto">
              ...
              {chatBot.messages.map((item, index) => (
                ...
                >
                  ...
                  {item.role == "user" ? (
                    <div className="justify-end self-end px-5 py-2 rounded-full bg-blue-200 w-auto">
                      {item.prompt}
                    </div>
                  ) : (
                    <div className="w-full">
                      <div className="bg-blue-400 flex gap-2 py-4 px-4 rounded-md min-w-[15rem] w-full">
